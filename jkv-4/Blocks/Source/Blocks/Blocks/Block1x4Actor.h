...
class BLOCKS_API ABlock1x4Actor : public ABlockBaseActor
{
	...
	ABlock1x4Actor() {
		...
		// 2) Ghost mesh & material
        static ConstructorHelpers::FObjectFinder<UStaticMesh> GhostMeshFinder(
            TEXT("StaticMesh'/Game/Blocks/Meshes/Block1x4.Block1x4'")
        );
        ...
        static ConstructorHelpers::FObjectFinder<UMaterialInterface> GhostMatFinder(
            TEXT("Material'/Game/Blocks/Meshes/M_GhostBlock.M_GhostBlock'")
        );
